...
    
    setTheme(initial);
    // Use the class toggling function
...
  if (!context) {
    // This now correctly throws an error if used outside the provider (Line 80)
...
      // Dynamic aria-label already here, which is correct
      aria-label={`Switch to ${theme === 'light' ? 'dark' : 'light'} mode`}
    >
      {theme === 'light' ? (
        <Sun className="w-5 h-5 text-yellow-500" /> // Used Tailwind color classes
      ) : (
        <Moon className="w-5 h-5 text-blue-400" /> // Used Tailwind color classes
      )}
    </button>
  );
}

// --- MAIN PAGE COMPONENTS (CONSOLIDATED AND TAILWIND STYLED) ---
...
          <h1 className="text-2xl font-bold m-0">hodlCoin</h1>
...
            
            {/* For Vault Creators */}
            {/* Equivalent of cardStyle (Line 227) */}
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
...
            {/* For Stakers */}
            {/* Equivalent of cardStyle (Line 276) */}
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <h3 className="text-2xl font-semibold mb-2">
                For Stakers
              </h3>
